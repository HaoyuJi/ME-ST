...
class Graph():
    ...
    def get_edge(self, layout): #self.center=0
        if layout == 'tp-vicon':
            self.num_node = 9
            ...
            self.num_node = 6
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(1, 0), (2, 1), (3, 0), (4, 3), (5, 4)]
            self.edge = self_link + neighbor_link
            self.center = 0
        elif layout == 'lara':
            self.num_node = 19
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(1, 0), (2, 1), (3, 2), (4, 3), (5, 0), (6, 5), (7, 6), (8, 7), (9, 0), (10, 9), (11, 9), (12,11), (13,12), (14,13), (15,9), (16,15), (17,16), (18,17)]
            self.edge = self_link + neighbor_link
            self.center = 0
        elif layout == 'pku-mmd':
            self.num_node = 25
            ...
            self.num_node = 17
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(1, 0), (2, 1), (3, 2), (4, 0), (5, 4), (6, 5), (7, 0), (8, 7), (9, 8), (10, 9), (11, 8),
